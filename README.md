...
| 명령어 | 기능 |
|--------|------|
| `/uxr 검색 [키워드]` | 가이드에서 UX 문구 검색 |
| `/uxr 카테고리 [이름]` | 카테고리별 문구 조회 |
| `/uxr 추천 [상황]` | AI가 가이드 기반으로 문구 제안 (채택/수정 버튼 포함) |
| `/uxr 피드백 [문구]` | 기존 문구의 개선점 분석 |
| `/uxr 비교 [A] vs [B]` | 두 문구 비교 분석 |
| `/uxr 검사 [문구]` | 가이드라인 일관성 자동 검사 |
| `/uxr 벌크검사 [문구1/문구2/...]` | 여러 문구 한번에 검사 |
| `/uxr 번역 [문구 또는 ID]` | 다국어 번역 (영어/일본어 등) |
